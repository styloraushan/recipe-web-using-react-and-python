...
// import "./Home.css"; // Import the extracted CSS file
...
//   // Apply responsive styles at 450px using JavaScript
//   if (window.innerWidth <= 450) {
//     styles.foodList.gridTemplateColumns = "repeat(auto-fill, minmax(180px, 1fr))"; // More items in a row
//     styles.foodList.gap = "10px"; // Reduce gap to fit more
//   }
